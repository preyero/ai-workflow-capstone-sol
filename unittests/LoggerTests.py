...
class LoggerTest(unittest.TestCase):
    ...
    def test_01_train(self):
        ...
        log_file = os.path.join("logs","train-test-all.log")
        ...
        update_train_log(tag, smodel, test,data_shape,eval_test, runtime,
    ...
    def test_03_predict(self):
        ...
        log_file = os.path.join("logs","predict-test-all.log")
        if os.path.exists(log_file):
            os.remove(log_file)
